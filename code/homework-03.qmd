...
Since my personal data has a lot to do with sleep and quality of sleep, I think that it could be cool to use time motifs in my data visualizations. Something along the lines of transitioning from night to day, or transitioning from unfocused to focused in some way. Maybe a figure is blurry and becomes un-blurred as the data moves from low to high sleep, but I don't know how I would make that look good with my data since it is very dramatic. I could also do something eye or brain related given that the crux of the test is reaction speed.
